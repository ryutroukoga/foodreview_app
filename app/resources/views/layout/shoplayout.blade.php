...
<head>
    ...
    <title>{{ config('app.name', '飲食店レビュー') }} - 店舗管理</title>
        ...
        <nav class="navbar navbar-marble">
            <div class="container">
                ...
                <div class="nav-marble">
                    ...
                    <a class="nav-link-marble" href="{{ route('shop.main') }}">
                        店舗メインページ
                    </a>
        ...
        <footer class="footer-marble">
            <div class="container">
                <div class="footer-text">
                    &copy; {{ date('Y') }} <span>◇</span> LuxReview for Business <span>◇</span>
                </div>
            </div>
        </footer>
    </div>
